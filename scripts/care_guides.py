...
PANELS=[('process','진료 과정','이야기를 듣는 시간부터 경과를 확인하는 진료까지.','assets/images/editorial/eb753b27d10c44.jpg'),('diagnostic','진단검사','무엇을 확인하는 검사인지, 결과는 어떻게 이해해야 하는지.','assets/images/spaces/room-ultrasound.jpg'),('prescription','한약처방','처방 이름을 살펴보고, 복용 전 확인할 내용을 알아보세요.','assets/images/spaces/tour-13.jpg'),('treatment','치료방법','진행 방법과 함께 적용 전 확인할 사항을 안내합니다.','assets/images/spaces/tour-08.jpg')]
