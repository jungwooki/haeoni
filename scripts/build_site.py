...
def header(current):
 ...
 language_link=f'<details class="header-language notranslate" translate="no"><summary aria-label="언어 선택 / 言語選択"><img class="language-flag" src="assets/images/flags/kr.svg" width="24" height="16" alt="" aria-hidden="true"><span class="language-code">KO</span><span aria-hidden="true">⌄</span></summary><div class="language-options"><a class="language-ko" href="{current}" data-original="https://haeoni.com/{current}" lang="ko" aria-current="true"><img src="assets/images/flags/kr.svg" width="24" height="16" alt="" aria-hidden="true"> 한국어</a><a class="language-ja" href="{esc(translate_url,quote=True)}" lang="ja"><img src="assets/images/flags/jp.svg" width="24" height="16" alt="" aria-hidden="true"> 日本語<small>Google 自動翻訳</small></a><p class="language-status" role="status" aria-live="polite" hidden></p><div id="google-translate-element"></div></div></details>'
