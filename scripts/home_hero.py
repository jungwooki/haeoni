...
SLIDES=[
 ('images/spaces/original-hero-2','해온한의원 진료실과 진찰 장비','한의원 진료실','이 진료실에서,<br>당신의 이야기로<br>진료를 시작합니다.','어디가 불편한지, 어떤 하루를 보내고 계신지.<br>해온의 진료는 당신의 이야기를 듣는 데서 시작합니다.','departments.html','해온의 진료 살펴보기','1920','1080'),
 ('images/spaces/room-ultrasound','초음파 장비가 마련된 해온한의원 스포츠진료실','정밀초음파 · 각종 검사','객관적인 검사로,<br>몸의 상태를<br>더 깊이 살핍니다.','정밀초음파와 각종 검사로 객관적인 정보를 확인합니다.<br>진찰에서 들은 이야기와 함께 몸의 상태를 살핍니다.','01_4.tour.html','진료·검사 공간 보기','1920','1080'),
 ('images/people/original-hero-1','해온한의원 4인 의료진','해온의 한의사','검사 결과에<br>당신의 이야기를<br>더합니다.','<strong>18년째, 20만 건 이상의 진료 경험.</strong><br>그 경험 위에 당신의 일상과 마음을 함께 담아,<br>해온의 한의사가 진료의 방향을 설명합니다.','01_2.team.html','의료진 만나보기','1920','900')
]
def home_hero():
 slides=[]
...
<div class="home-slide-photo"><img src="{asset_url(photo)}" alt="{alt}" width="{width}" height="{height}"{priority}></div>
